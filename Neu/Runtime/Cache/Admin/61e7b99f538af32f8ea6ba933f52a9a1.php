...
<br><br>
    ...
    <div class="container-fluid">
        ...
        <form action="/plan/index.php/Admin/Shiyan/edit?id=290&ccode=B100100700" method="post">
            <table class="table table-condensed table-bordered table-striped table-hover">
                ...
                <tr>
                    <td>《
                        <input value="<?php echo ($data["CName"]); ?>" name="CName" required type="text" class="inline-input" style="width: 20%;" placeholder="教学大纲名称">
                        》实验教学大纲
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>课程代码：
                        <input value="<?php echo ($data["CCode"]); ?>" name="CCode" required type="text" class="inline-input" placeholder="字母C开头的课程编号">
                    </td>
                </tr>
                <tr>
                    <td>学时数：
                        <input value="<?php echo ($data["TNum"]); ?>" name="TNum" required type="text" class="inline-input" placeholder="填写数字">学时
                    </td>
                </tr>
                <tr>
            ...
            <table class="table table-condensed table-bordered table-striped table-hover">
                ...
                <tbody>
                <tr>
                    <td>场地：<input value="<?php echo ($data["TAddress"]); ?>" required name="TAddress" type="text" class="inline-input" placeholder="XXX">实验室</td>
                </tr>
                <tr>
