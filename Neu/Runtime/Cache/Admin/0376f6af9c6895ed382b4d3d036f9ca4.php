...
<br><br>
    ...
    <div class="container-fluid   table-responsive">
      <!--  <table class="navbar navbar-default  panel-body table-responsive">
            <tr>
                <td>
        ...
        <table class="table table-bordered table-hover">
            <caption>
                <form class="navbar-form" action="/plan/index.php/Admin/kecheng/overlook" method="post">
                    <p>
                        菜单项：
                        <a href="/plan/index.php/Admin/Kecheng/showc" class="btn btn-xs btn-primary">C版课程库</a> |
                        <a href="/plan/index.php/Admin/Kecheng/showb" class="btn btn-xs btn-primary">B版课程库</a>
                        <a href="/plan/index.php/Admin/Kecheng/reference" target="_blank" class="btn btn-xs btn-info">资源经济学（范例）</a>
                    </p>
                    筛选条件：
                ...
                <?php else: ?>
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                            <td><?php echo ($k+1); ?></td>
                            <td>
                                <?php if($vo["status"] == 2): ?><a href="/plan/index.php/Admin/Kecheng/edit?ccode=<?php echo ($vo["CCode"]); ?>" title="编辑"><?php echo ($vo["CName"]); ?></a>
                                    <!--<span class="disabled glyphicon glyphicon-off"></span><?php echo ($vo["CName"]); ?>-->
                                    <?php else: ?>
                                    <a href="/plan/index.php/Admin/Kecheng/edit?ccode=<?php echo ($vo["CCode"]); ?>" title="编辑"><?php echo ($vo["CName"]); ?></a><?php endif; ?>
                            </td>
                            ...
                            <td class="text-center" nowrap="">
                                <?php if($vo["status"] == 2): ?><a class="btn btn-xs btn-success" href="/plan/index.php/Admin/Kecheng/auth?ccode=<?php echo ($vo["CCode"]); ?>" title="授权使其有修改的权限">授权</a>
                                    <?php else: ?>
                                    <a href="/plan/index.php/Admin/Kecheng/edit?ccode=<?php echo ($vo["CCode"]); ?>" title="编辑"><span class="glyphicon glyphicon-edit"></span></a><?php endif; ?>
                            </td>
                            <td>
                                <?php if($vo["status"] == 0): ?><a href="/plan/index.php/Admin/Kecheng/confirm?ccode=<?php echo ($vo["CCode"]); ?>" class="btn btn-xs btn-primary">待确认</a>
                                    <?php elseif($vo["status"] == 1): ?>
                                    <a href="/plan/index.php/Admin/Kecheng/check?ccode=<?php echo ($vo["CCode"]); ?>" class="btn btn-xs btn-success"><span class="glyphicon glyphicon-bell"></span> 待审核</a>
                                    <?php else: ?>
                                    <a href="/plan/index.php/Admin/Kecheng/confirm?ccode=<?php echo ($vo["CCode"]); ?>" class="btn btn-xs btn-warning">
