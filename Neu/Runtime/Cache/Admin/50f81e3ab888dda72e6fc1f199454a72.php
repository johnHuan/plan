...
<br><br>
    ...
    <div class="container-fluid table-responsive">
        <table class="table table-bordered table-hover">
            <caption>
                <form class="navbar-form" action="/plan/index.php/Admin/shiyan/guideBook" method="post">
                    筛选条件：
                    ...
                    <div class="pull-right">
                            <span>
                                <a href="/plan/index.php/Admin/Shiyan/abscentB" class="btn btn-xs btn-primary">缺B版</a> |
                                <a href="/plan/index.php/Admin/Shiyan/abscentC" class="btn btn-xs btn-primary">缺C版</a> |
                                <a href="/plan/index.php/Admin/Shiyan/abscentBC" class="btn btn-xs btn-primary">缺B+C版</a>
                            </span>
                    </div>
                </form>
            </caption>
    ...
    <script>
        ...
        $(function () {
            ...
            $("button").on('click', function () {
                ...
                $("#fileupload").wrap("<form id='myupload' action='/plan/index.php/Admin/Shiyan/uploadGuideBook' method='post' enctype='multipart/form-data'></form>");
...
//                        window.location = "/plan/index.php/Admin/Shiyan/guideBook";
                    },
