...
<br><br>
    ...
    <div class="container-fluid table-responsive">
        <table class="table table-bordered">
            <caption>
                <form class="navbar-form" action="/plan/index.php/Admin/Shiyan/showc" method="post">
                    <p>菜单项：
                ...
                <?php if(is_array($data)): foreach($data as $k=>$vo): ?><tr>
                            ...
                            <?php if($vo["status"] == 0): ?><td class="bg-danger">
                                    ...
                                    <a class="text-success" href="/plan/index.php/Admin/Shiyan/add?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["课程编号"]); ?>&flag=0" title="填写与完善"><?php echo ($vo["课程名称"]); ?></a>
                                </td>
                            <?php else: ?>
                            ...
                            <td class="text-center">
                                <?php if($vo["status"] == 0): ?><a href="/plan/index.php/Admin/Shiyan/add?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["课程编号"]); ?>&flag=0" title="填写与完善"><span class="glyphicon glyphicon-plus-sign"></span></a>
