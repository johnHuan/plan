...
<br><br>
    ...
    <div class="container-fluid" data-spy="scroll" data-target="#myscrollspy">
        <div class="header">
            <h1 class="text-center">资土学院 实践指导书</h1>
        </div>
    </div>
    ...
    <div class="container-fluid table-responsive">
        <table class="table table-bordered table-hover table-scrollable">
            <caption>
                <form class="navbar-form" action="/plan/index.php/Admin/shijian/guideBook" method="post">
                    筛选条件：
                    ...
                    <div class="pull-right">
                        <span>
                            <a href="/plan/index.php/Admin/Shijian/abscentB" class="btn btn-xs btn-primary">缺B版</a> |
                            <a href="/plan/index.php/Admin/Shijian/abscentC" class="btn btn-xs btn-primary">缺C版</a> |
                            <a href="/plan/index.php/Admin/Shijian/abscentBC" class="btn btn-xs btn-primary">缺B+C版</a>
                        </span>
                    </div>
                </form>
            </caption>
            <tr>
                ...
                <th nowrap="true">学时数</th>
                <th nowrap="true">学分数</th>
                <th nowrap="true">执笔人</th>
                <th nowrap="true" style="overflow: hidden">讨论参加人</th>
            ...
            <?php else: ?>
                <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                        ...
                        <td nowrap="true"><?php echo ($vo["CName"]); ?></td>
                        <td nowrap="true"><?php echo ($vo["CCode"]); ?></td>
                        <td nowrap="true"><?php echo ($vo["SMajor"]); ?></td>
                        <td nowrap="true"><?php echo ($vo["TNum"]); ?></td>
                        <td nowrap="true"><?php echo ($vo["TScore"]); ?></td>
                        <td nowrap="true"><?php echo ($vo["TzhiBiRen"]); ?></td>
                        <td nowrap="true" style="overflow: hidden;
text-overflow:ellipsis;
white-space: nowrap;width: 300px;height:25px; overflow: hidden"><?php echo ($vo["TTaoLunCanJia"]); ?></td>
                        <td>
                            <?php if($vo["filename"] == NULL): ?><button class="btn btn-xs btn-primary" data-toggle="modal" data-target="#uploadFile" data-id="<?php echo ($vo["id"]); ?>" data-ccode="<?php echo ($vo["CCode"]); ?>" title="上传实践指导书" id="<?php echo ($vo["CCode"]); ?>"><span class="glyphicon glyphicon-upload"></span></button>
                                <?php else: ?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">上传实践指导书（pdf文件）</h4>
                </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $("button").on('click', function () {
                ...
                $("#fileupload").wrap("<form id='myupload' action='/plan/index.php/Admin/Shijian/uploadGuideBook' method='post' enctype='multipart/form-data'></form>");
...
//                        window.location = "/plan/index.php/Admin/Shijian/guideBook";
                    },
