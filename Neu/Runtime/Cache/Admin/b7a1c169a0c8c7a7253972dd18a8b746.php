...
<br><br>
    ...
    <div class="container-fluid   table-responsive">
        <table class="table table-bordered table-hover">
            <caption>
                <form class="navbar-form" action="/plan/index.php/Admin/kecheng/info" method="post">
                    筛选条件：
                ...
                <?php else: ?>
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                            ...
                            <td>
                                <?php if($vo["status"] == 2): ?><a href="/plan/index.php/Admin/Kecheng/introduction?ccode=<?php echo ($vo["CCode"]); ?>" title="编辑"><?php echo ($vo["CName"]); ?></a>
                                    <!--<span class="disabled glyphicon glyphicon-off"></span><?php echo ($vo["CName"]); ?>-->
                                    <?php else: ?>
                                    <a href="/plan/index.php/Admin/Kecheng/introduction?ccode=<?php echo ($vo["CCode"]); ?>" title="编辑"><?php echo ($vo["CName"]); ?></a><?php endif; ?>
                            </td>
                            ...
                            <td>
                                <?php if($vo["status"] == 0): ?><a href="/plan/index.php/Admin/Kecheng/introduction?ccode=<?php echo ($vo["CCode"]); ?>" class="btn btn-xs btn-primary" title="待编辑， 点击编辑">
                                        <span class="glyphicon glyphicon-question-sign"></span>
                                    </a>
                                <?php elseif($vo["status"] == 1): ?>
                                    <a href="/plan/index.php/Admin/Kecheng/infoConfirm?ccode=<?php echo ($vo["CCode"]); ?>" class="btn btn-xs btn-success" title="已完成, 点击查看Word板式">
