...
<br><br>
    ...
    <div class="container-fluid">
        ...
        <form class="navbar-form" action="/plan/index.php/Admin/Task/showTaskInfo?v=782" method="post">
                筛选条件：
            ...
            <div class="pull-right text-info download-john"><a class="btn btn-primary" href="/plan/index.php/Admin/Task/excel">下载数据</a></div>
        </form>
        <table class="suitHeight easyui-datagrid" data-options="rownumbers:true,singleSelect:true">
            ...
            <?php if($data == ''): ?><tr>
                ...
                <?php if(is_array($data)): foreach($data as $k=>$vo): ?><tr>
                        <td>
                            <?php if($vo["status"] == 0): ?><a href="/plan/index.php/Admin/Task/edit?num=<?php echo ($vo["任务号"]); ?>" class="btn btn-xs btn-primary"
                                   title="待编辑， 点击编辑">
                        ...
                        <td>
                            <?php if($vo["status"] == 1): ?><a href="/plan/index.php/Admin/Task/edit?num=<?php echo ($vo["任务号"]); ?>" title="编辑"><?php echo ($vo["课程名称"]); ?></a>
                                <?php else: ?>
                                <a href="/plan/index.php/Admin/Task/edit?num=<?php echo ($vo["任务号"]); ?>" title="编辑"><?php echo ($vo["课程名称"]); ?></a><?php endif; ?>
                        </td>
