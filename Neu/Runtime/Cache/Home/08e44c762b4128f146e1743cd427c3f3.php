...
<br><br>
    ...
    <div class="container-fluid table-responsive">
        <table class="table table-bordered table-hover">
            <caption>
                <form class="navbar-form" action="/plan/index.php/Home/shiyan/overlook" method="post">
                    <p>
                        菜单项：
                        <a href="/plan/index.php/Home/Shiyan/showc" class="btn btn-xs btn-primary">C版课程库</a> |
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                            ...
                            <td class="text-center">
                                <?php if($vo["status"] == 2): ?><span class="disabled glyphicon glyphicon-off"></span>
                                    <?php else: ?>
                                    <a href="/plan/index.php/Home/Shiyan/edit?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["CCode"]); ?>" title="编辑"><span class="glyphicon glyphicon-edit"></span></a><?php endif; ?>
                                <!--<a href="/plan/index.php/Home/Shiyan/delete?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["CCode"]); ?>" title="删除"><span class="glyphicon glyphicon-remove"></span></a>-->
                            </td>
                            <td>
                                <?php if($vo["status"] == 0): ?><a href="/plan/index.php/Home/Shiyan/confirm?id=<?php echo ($vo["id"]); ?>&CCode=<?php echo ($vo["CCode"]); ?>" class="btn btn-xs btn-primary">待确认</a>
                                    <!--<form action="/plan/index.php/Home/Shiyan/confirm" method="post">-->
                                       <!--<span class="glyphicon glyphicon-check"></span>-->
                                        <!--<input type="hidden" value="<?php echo ($vo["CCode"]); ?>" name="CCode">-->
                                        <!--<input type="hidden" value="<?php echo ($vo["id"]); ?>" name="id">-->
                                        <!--<input type="submit" value="待确认" class="">-->
                                    <!--</form>-->
