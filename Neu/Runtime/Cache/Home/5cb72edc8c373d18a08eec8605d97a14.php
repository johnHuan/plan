...
<br><br>
    ...
    <div class="container-fluid">
        ...
        <form action="/plan/index.php/Home/Kecheng/editDo" method="post" data-toggle="validator" id="myForm" role="form">
            ...
            <div class="panel-body table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td colspan="9">
                            <textarea name="TreferBook" cols="30" rows="5" required><?php echo ($data["TreferBook"]); ?></textarea>
                        </td>
                    </tr>
                    <tr>
