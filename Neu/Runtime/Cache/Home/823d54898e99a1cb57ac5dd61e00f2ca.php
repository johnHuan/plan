...
<br><br>
    ...
    <div class="container-fluid table-responsive">
        <table class="table table-bordered table-hover">
            <caption>
                <form class="navbar-form" action="/plan/index.php/Home/shiyan/detail" method="post">
    ...
    <script>
        ...
        $(function () {
            ...
            $("button").on('click', function () {
                ...
                $("#fileupload").wrap("<form id='myupload' action='/plan/index.php/Home/Shiyan/uploadCard' method='post' enctype='multipart/form-data'></form>");
...
//                        window.location = "/plan/index.php/Home/Shiyan/detail";
                        },
