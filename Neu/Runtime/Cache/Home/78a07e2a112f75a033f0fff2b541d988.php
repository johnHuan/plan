...
<br><br>
    ...
    <div class="container-fluid" data-spy="scroll" data-target="#myscrollspy">
        <div class="header">
            <h1 class="text-center">资土学院 课程教学大纲(B版课程库)</h1>
        </div>
    </div>
    ...
    <div class="container-fluid table-responsive">
        <table class="table table-bordered ">
            <caption>
                <form class="navbar-form" action="/plan/index.php/Home/Kecheng/showb" method="post">
                    <p>
                    菜单项：
                        <a href="/plan/index.php/Home/Kecheng/showc" class="btn btn-xs btn-primary">C版课程库</a> |
                        <a href="javascript:void(0);" class="active btn btn-next">B版课程库</a>
                    </p>
                    筛选条件：
                    ...
                    <div data-toggle="buttons" class="btn-group">
                        <label class="btn btn-default"><input name="status" type="radio" value="1">已填写</label>　
                        <label class="btn btn-default"><input name="status" type="radio" value="0">待填写</label>　
                    </div>
                    <div class="form-group">
            ...
            <tr>
                ...
                <?php if(is_array($data)): foreach($data as $k=>$vo): ?><tr>
                        ...
                        <?php if($vo["status"] == 0): ?><td class="bg-danger">
                                ...
                                <a class="text-success" href="/plan/index.php/Home/Kecheng/add?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["课程编号"]); ?>&flag=1" title="填写与完善"><?php echo ($vo["课程名称"]); ?></a>
                            </td>
                        <?php else: ?>
                        ...
                        <td><?php echo ($vo["学期学分"]); ?></td>
                        <td><?php echo ($vo["学期学时"]); ?></td>
                        <td><?php echo ($vo["理论学时"]); ?></td>
                        <td><?php echo ($vo["实验学时"]); ?></td>
                        <td><?php echo ($vo["上机学时"]); ?></td>
                        <td class="text-center">
                            <?php if($vo["status"] == 0): ?><a href="/plan/index.php/Home/Kecheng/add?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["课程编号"]); ?>&flag=1" title="填写与完善"><span class="glyphicon glyphicon-plus-sign"></span></a>
                                <?php else: ?>
