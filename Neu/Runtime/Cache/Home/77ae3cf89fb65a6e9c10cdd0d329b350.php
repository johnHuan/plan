    ...
    <div class="container-fluid table-responsive">
        <table class="table table-bordered">
            <caption>
                ...
                <form class="navbar-form" action="/plan/index.php/Home/Shijian/showc?nsukey=igvxFpVHuIyOCjgvwmRrbaSRtfovR9FC7cs2MieuiGKp4MzhXvcMJtyO%2FECn8ly28ZdVUcovmn9ThKmevHOo0iqtSZoyG3JfwnB2Le9HQ5gyqgTC9M5KdxVYlFv%2Fc4vGNFosjg6VAHLX2yB%2F7F%2FdBk%2B6jbOReVjFMt9yLTx5ZytHAdziKVjJOBKofWsGSKtqpJrkA7M8ZWvqQHZF66IB4w%3D%3D" method="post">
                    筛选条件：
                ...
                <?php if(is_array($data)): foreach($data as $k=>$vo): ?><tr>
                            ...
                            <?php if($vo["status"] == 0): ?><td class="bg-danger">
                                    ...
                                    <a class="text-success" href="/plan/index.php/Home/Shijian/add?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["课程编号"]); ?>&flag=0" title="填写与完善"><?php echo ($vo["课程名称"]); ?></a>
                                </td>
                            <?php else: ?>
                            ...
                            <td class="text-center">
                                <?php if($vo["status"] == 0): ?><a href="/plan/index.php/Home/Shijian/add?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["课程编号"]); ?>&flag=0" title="填写与完善"><span class="glyphicon glyphicon-plus-sign"></span></a>
