...
<body>
	<div class="container-fluid">
		<div class="wrapper">
			<div class="header">
				<h3 class="text-center hidden-xs">东北大学 资源与土木工程学院 </h3>
			</div>
			<!--main-->
			<div class="content">
				<!--login start-->
				<div class="row">
					<h2 class="text-center hidden-xs"><b>教师登录</b></h2>
					<div class="col-lg-12 col-sm-12">
						<form id="login" action="/plan/index.php/Index/Index.html" class="form-horizontal" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<img src="/plan/index.php/Home/Index/verifyImg" alt="验证码" onclick="javascript:this.src='/plan/index.php/Home/Index/verifyImg?tm='+Math.random();" /><!--看不清楚？点击左侧验证码图片更换一张-->
									<!--<a onclick="javascript:this.src='/plan/index.php/Home/Index/verifyImg?tm='+Math.random();" >看不清楚？换一张</a>-->
								</div>
							</div>
							<div class="form-group">
		...
		$(function(){
			...
			$('#submit').on('click', function(event){
				...
				$.ajax({
					...
					url: '/plan/index.php/Index/Index.html',
					beforeSend: function(){
					...
					success: function (res) {
						if (res == 1){
							...
							location.href = "/plan/index.php/Home/shiyan/overlook";
//							location.href = "/plan/index.php/Home/Task/showTaskInfo";
						}
					},
					complete: function(){
