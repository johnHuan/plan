...
<br><br>
    ...
    <div class="container-fluid">
        ...
        <br>
        <form action="/plan/index.php/Home/Task/editDo" method="post" data-toggle="validator" id="myForm" role="form">
...
//            dataType: 'json',
                type: 'post',
                url: '/plan/index.php/Home/Task/saveTemp',
                beforeSend: function () {
                    $("#save").html("交互中。。。");
                },
        ...
        $(".reload").on('click', function () {
            $.ajax({
                ...
                type: 'post',
                url: '/plan/index.php/Home/Task/reload',
                beforeSend: function () {
                    $("#reload").html("恢复中。。。");
                },
                success: function (response) {
