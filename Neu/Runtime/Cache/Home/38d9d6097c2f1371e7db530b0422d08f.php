    ...
    <div class="container-fluid">
        <nav class="navbar navbar-default">
            <div class="container-fluid" >
                ...
                <div class="collapse navbar-collapse">
                    <form class="navbar-form" action="/plan/index.php/Home/shijian/overlook?nsukey=jZB7JFir6Ftp%2FpPuPqZ0fto7vHeSJGvdjUlwmGEdgq6yZYa5gnZ9jlbLV7HMuexF0NHWx41KUR6qCKAcQrUQb7Zi4IukTKB9q31jN4257ewssD76PVGGs0W48l2SPGINTHoEMmhJ3eZ9PqHOlDzskpht%2BjXDh4pScu6ogt1fAe4y8%2B%2BArgmLiuVtaiBMPrjaZZAgX6FJFIi8zUf1H6NWKw%3D%3D" method="post">
                        筛选条件：
        ...
        <table class="table table-bordered table-hover">
            <caption>
                菜单项：
                <span>
                    <a href="/plan/index.php/Home/Shijian/showc" class="btn btn-xs btn-primary">C版课程库</a> |
                    <a href="/plan/index.php/Home/Shijian/showb" class="btn btn-xs btn-primary">B版课程库</a>
                </span>
            </caption>
                <tr>
                    <th>序号</th>
                ...
                <?php else: ?>
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                            <td><?php echo ($k+1); ?></td>
                            <td><a href="/plan/index.php/Home/Shijian/edit?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["CCode"]); ?>" title="编辑"><?php echo ($vo["CName"]); ?></a></td>
                            ...
                            <td class="text-center">
                                <?php if($vo["status"] == 2): ?><span class="disabled glyphicon glyphicon-off"></span>
                                    <?php else: ?>
                                    <a href="/plan/index.php/Home/Shijian/edit?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["CCode"]); ?>" title="编辑"><span class="glyphicon glyphicon-edit"></span></a><?php endif; ?>
                                <!--<a href="/plan/index.php/Home/Shijian/delete?id=<?php echo ($vo["id"]); ?>&ccode=<?php echo ($vo["CCode"]); ?>" title="删除"><span class="glyphicon glyphicon-remove"></span></a>-->
                            </td>
                            <td>
                                <?php if($vo["status"] == 0): ?><a href="/plan/index.php/Home/Shijian/confirm?id=<?php echo ($vo["id"]); ?>&CCode=<?php echo ($vo["CCode"]); ?>" class="btn btn-xs btn-primary">待确认</a>
                                    <?php elseif($vo["status"] == 1): ?><span class="glyphicon glyphicon-bell"></span> 待审核
                                    <?php else: ?><span class="disabled glyphicon glyphicon-ok">已通过</span><?php endif; ?>
                            </td>
