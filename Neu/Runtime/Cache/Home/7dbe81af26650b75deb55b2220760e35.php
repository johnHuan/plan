...
<br><br>
    ...
    <div class="container-fluid table-responsive">
        <table class="table table-bordered table-hover table-scrollable">
            <caption>
                <form class="navbar-form" action="/plan/index.php/Home/shijian/guideBook" method="post">
                    筛选条件：
    ...
    <script>
        ...
        $(function () {
            ...
            $("button").on('click', function () {
                ...
                $("#fileupload").wrap("<form id='myupload' action='/plan/index.php/Home/Shijian/uploadGuideBook' method='post' enctype='multipart/form-data'></form>");
...
//                        window.location = "/plan/index.php/Home/Shijian/guideBook";
                    },
