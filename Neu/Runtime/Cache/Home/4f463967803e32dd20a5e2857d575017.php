...
<br><br>
    ...
    <div class="container-fluid table-responsive">
        <table class="table table-bordered table-hover">
            <caption>
                <form class="navbar-form" action="/plan/index.php/Home/kecheng/shedual" method="post">
                    筛选条件：
                    <div class="form-group">
                        <select name="year" class="selectpicker form-control">
                            <option value="">--选择计划批次--</option>
                            <option value="2017">2017本科版</option>
                            <option value="2016">2016本科版</option>
                            <option value="2015">2015本科版</option>
                            <option value="2014">2014本科版</option>
                            <option value="2013">2013本科版</option>
                            <option value="2012">2012本科版</option>
                            <option value="2011">2011本科版</option>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <?php else: ?>
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                            ...
                            <td>
                                <?php if($vo["CName"] != ''): ?><a href="/plan/index.php/Home/Kecheng/confirm?ccode=<?php echo ($vo["课程编号"]); ?>" title="查看word打印页面"><?php echo ($vo["课程编号"]); ?></a>
                                    <?php else: ?>
                                    <?php echo ($vo["课程编号"]); endif; ?>
                                </td>
                            <td>
                                <?php if($vo["CName"] != ''): ?><a href="/plan/index.php/Home/Kecheng/edit?ccode=<?php echo ($vo["课程编号"]); ?>" title="查看编辑修改页面"><?php echo ($vo["课程名称"]); ?></a>
                                    <?php else: ?>
                                    <?php echo ($vo["课程名称"]); endif; ?>
                            </td>
                            <td><?php echo ((isset($vo["totalSNum"]) && ($vo["totalSNum"] !== ""))?($vo["totalSNum"]):"<span class='text-danger'>还没填呢</span>"); ?></td>
                            <td><?php echo ((isset($vo["CMaster"]) && ($vo["CMaster"] !== ""))?($vo["CMaster"]):"<span class='text-danger'>还没填呢</span>"); ?></td>
